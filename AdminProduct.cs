...
namespace MenuCRUD
{
    public partial class Form1 : Form
    {
        ...
        {
            var product = new Product { ProductName = txtProductName.Text, Quantity = Convert.ToInt32(txtQuantity.Text),
                Price = Convert.ToInt32(txtPrice.Text), Origin = txtOrigin.Text, CategoryId = Convert.ToInt32(comboBox1.Text) };
